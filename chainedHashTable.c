 ...
 *       26 March 2013
 *
 *   Modify multiHashTableLookup by GET_A team for CPE111 project
...
/* use to find tags in hashTable that user input 
 * and will find photo that match with tags and return it.
 *
 */
void *multiHashTableLookup(char *key, int *pCount)
    {
    void **foundData = NULL;
    HASH_ITEM_T *pPrev = NULL;
    HASH_ITEM_T *pTemp = NULL;
